...
export const DEBUG_SERIAL_SEND = 'DEBUG_SERIAL_SEND';
export const SERIAL_SESSION_MESSAGE_RECEIVE = 'SERIAL_SESSION_MESSAGE_RECEIVE';
export const STOP_DEBUG_SESSION = 'STOP_DEBUG_SESSION';
export const DEBUG_SESSION_STOPPED = 'DEBUG_SESSION_STOPPED';
export const SERIAL_PORT_CLOSED = 'SERIAL_PORT_CLOSED';
...
export const CHECK_ARDUINO_DEPENDENCY_UPDATES =
...
export const COMPILE_SIMULATION = 'COMPILE_SIMULATION';

export const CHECK_EMSDK_INSTALLED = 'CHECK_EMSDK_INSTALLED';
export const INSTALL_EMSDK = 'INSTALL_EMSDK';
export const UNINSTALL_EMSDK = 'UNINSTALL_EMSDK';
