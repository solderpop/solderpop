...
const subscribeOnUpdateAvailable = R.curry((callback, autoUpdater) =>
  autoUpdater.on('update-available', callback)
);

// :: (ProgressObj -> ()) -> autoUpdater -> autoUpdater
const subscribeOnUpdateProgress = R.curry((callback, autoUpdater) =>
...
const subscribeOnUpdateRequested = R.curry((callback, ipcMain, autoUpdater) => {
...
export const subscribeOnAutoUpdaterEvents = (send, ipcMain, autoUpdater) =>
  R.compose(
    subscribeOnUpdateRequested(
