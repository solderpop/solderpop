...
/**
 * Path for a 'magic' patch, whose instance is placed
 * to mark record patches.
 */
export const RECORD_MARKER_PATH = 'xod/patch-nodes/record';

/**
 * Path for a 'magic' patch, whose instance is placed
 * in an autogenerated unpack patch to mark it for further
 * code generation and processing.
 */
export const UNPACK_RECORD_MARKER_PATH = 'xod/patch-nodes/unpack-record';
