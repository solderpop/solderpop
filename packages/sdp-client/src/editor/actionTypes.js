...
export const TABTEST_LAUNCHED = 'TABTEST_LAUNCHED';
export const TABTEST_RUN_FINISHED = 'TABTEST_RUN_FINISHED';
export const TABTEST_ABORT = 'TABTEST_ABORT';
export const TABTEST_ERROR = 'TABTEST_ERROR';

export const SIMULATION_RUN_REQUESTED = 'SIMULATION_RUN_REQUESTED';
export const SIMULATION_GENERATED_CPP = 'SIMULATION_GENERATED_CPP';
export const SIMULATION_COMPILED = 'SIMULATION_COMPILED';
