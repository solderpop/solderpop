...
The package provides API to work with workspaces, libraries and projects that are stored as different files on the file system. It lets converting between normal (split files), solderball (single project monolith), and RAM representation.
